...
var help = function(callback) {
    cli.log.help("show: Display current selected configuration.");
    cli.log.help("set <parameter> <value>: Set service parameter with value.");
    cli.log.help("use <service_nickname>: Set which service the command line tool should work against.");
