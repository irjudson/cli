        ...
        cli.service.getService(function(err, service) {
            ...
            service.create(principal, function(err, session, createdPrincipal) {
                ...
                if (type !== 'user') {
                    ...
                    cli.log.info("Credentials for created principal:");
                    cli.log.info("public key: " + createdPrincipal.public_key);
                    cli.log.info("");
                    cli.log.info("private key: " + createdPrincipal.public_key);
                    cli.log.info("");
                    cli.log.info("Please immediately copy the private key to safe storage. If lost, this principal will be unrecoverable.");
