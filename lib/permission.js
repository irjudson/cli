...
var help = function(callback) {
    cli.utils.displayCommands('Permission Commands', [
        ['add',  'Adds a permission.'],
        ['',     '  --action: action this permission authorizes (default: all)'],
        ['',     '  --issuedTo: principal this permission is issued to (default: all)'],
        ['',     '  --principalFor: principal this permission is for (default: all)'],
        ['',     '  --priority: priority of this permission in the permission list (default: NORMAL_PRIORITY)'],
        ['',     '  --authorized: boolean flag that indicates if this permission authorizes or forbids (default: true)']
    ]);
