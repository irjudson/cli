...
var help = function(callback) {                
    cli.log.help('install <module-name> <reactor_id> <instance_id> [--version]:  Install app into reactor instance.');
    cli.log.help('start <reactor_id> <instance_id>:  Start app in reactor instance.');
...
module.exports.execute = function(callback) {
    ...
    switch(command) {
        ...
        default: {
            cli.log.error('unknown app command: ' + command);
            break;
        }
    }
};